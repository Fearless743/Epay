	...
	$.ajax({
		...
		success : function(data) {
			if(data.code == 0){
				...
				paymsg+='<a class="btn btn-default btn-block" href="settle_batch.php?type=5&batch='+batch+'" style="margin-top:10px;"><img width="20" src="../assets/icon/usdt.ico" class="logo">USDT批量转账</a>';
